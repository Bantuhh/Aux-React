...
var SpotifyWebPlayer = (function (_super) {
    ...
    function SpotifyWebPlayer(props) {
        ...
        _this.handlePlayerStateChanges = function (state) { return __awaiter(_this, void 0, void 0, function () {
            ...
            // check if song ended and skip to next song.
            if (
                this.state
                ...
                // When track ends, it gets to this point three times, so only skip on the first attempt
                if (global.trackEndSkipAttempt == 0) {
                    console.log('Track ended');

                    // skip to next song in queue
                    global.skipSong();

                    global.trackEndSkipAttempt = 1;
                } else if (global.trackEndSkipAttempt == 1) {
                    global.trackEndSkipAttempt = 2;
                } else if (global.trackEndSkipAttempt == 2) {
