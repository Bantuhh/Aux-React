...
var Util = /** @class */ (function () {
    function Util(api) {
        ...
        this.streamLink = function (songUrl) { return __awaiter(_this, void 0, void 0, function () {
            var headers, html, match, url, client_id, connect, _a;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        html = _c.sent();
                        match = (_b = html.data.match(/(?<=,{"url":")(.*?)(progressive)/)) === null || _b === void 0 ? void 0 : _b[0];
                    ...
                    case 3:
                        _c.trys.push([3, 5, , 8]);
                        return [4 /*yield*/, axios_1["default"].get(match + connect, { headers: headers }).then(function (r) { return r.data.url; })];
                    case 4:
                        url = _c.sent();
                        return [3 /*break*/, 8];
                    case 5:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.streamLink(songUrl)];
                    case 1:
                        url = _a.sent();
                        return [4 /*yield*/, axios_1["default"].get(url, { headers: headers, responseType: "stream" }).then(function (r) { return r.data; })];
                    case 2:
                        readable = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        finalMP3 = path.extname(dest) ? dest : path.join(dest, title + ".mp3");
        ...
        this.downloadTrack = function (trackResolvable, dest) { return __awaiter(_this, void 0, void 0, function () {
            var folder, track, client_id, result, url, title;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!dest)
                        ...
                        if (!(track.downloadable === true)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.api.getClientID()];
                    case 1:
                        client_id = _a.sent();
                        return [4 /*yield*/, axios_1["default"].get(track.download_url, { responseType: "arraybuffer", params: { client_id: client_id } })];
                    case 2:
                        result = _a.sent();
                    ...
                    case 3: return [2 /*return*/, this.downloadTrackStream(track.permalink_url, track.title.replace(/\//g, ""), dest)];
        ...
        this.streamTrack = function (trackResolvable) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        client_id = _a.sent();
                        return [4 /*yield*/, axios_1["default"].get(track.download_url, { responseType: "stream", params: { client_id: client_id, oauth_token: this.api.oauthToken } })];
                    case 2: return [2 /*return*/, _a.sent()];
                    case 3: return [4 /*yield*/, this.downloadTrackReadableStream(track.permalink_url)];
                    case 4: return [2 /*return*/, _a.sent()];
                    case 5: return [3 /*break*/, 8];
                    case 6:
                        url = trackResolvable;
                        return [4 /*yield*/, this.downloadTrackReadableStream(url)];
         ...
         */
        this.downloadSongCover = function (trackResolvable, dest) { return __awaiter(_this, void 0, void 0, function () {
            var folder, track, artwork, title, client_id, arrayBuffer;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!dest)
                    ...
                    case 4:
                        client_id = _a.sent();
                        return [4 /*yield*/, axios_1["default"].get(artwork, { responseType: "arraybuffer", params: { client_id: client_id, oauth_token: this.api.oauthToken } }).then(function (r) { return r.data; })];
                    case 5:
                        arrayBuffer = _a.sent();
