...
export declare class Util {
     ...
     */
    downloadTrackStream: (songUrl: string, title: string, dest: string) => Promise<string>;
    /**
     ...
     */
    downloadSongCover: (trackResolvable: string | SoundcloudTrack | SoundcloudTrackV2, dest?: string) => Promise<string>;
    /**
