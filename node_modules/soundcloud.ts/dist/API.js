...
var API = /** @class */ (function () {
    function API(clientID, oauthToken) {
        ...
        this.get = function (endpoint, params) { return __awaiter(_this, void 0, void 0, function () {
            var _a, response, _b, _c, response;
        ...
        this.getURI = function (URI, params) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        _d.trys.push([2, 4, , 7]);
                        return [4 /*yield*/, axios_1["default"].get(URI, { params: params, headers: API.headers })];
                    case 3:
                        response = _d.sent();
                        return [2 /*return*/, response];
                    case 4:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios_1["default"].get("https://soundcloud.com/").then(function (r) { return r.data; })];
                    case 1:
                        response = _b.sent();
                        urls = response.match(/(?!<script crossorigin src=")https?:\/\/(www\.)?[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_\+.~#?&//=]*\.js)(?=">)/g);
                        script = void 0;
                        _b.label = 2;
                    case 2: return [4 /*yield*/, axios_1["default"].get(urls.pop()).then(function (r) { return r.data; })];
                    case 3:
                        script = _b.sent();
                        _b.label = 4;
                    case 4:
